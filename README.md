...
The static public website for Did You Pay?, built for hosting on GitHub Pages.
...
Configure GitHub Pages to publish from the repository's default branch and root directory. No build step is required.
